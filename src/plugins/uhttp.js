...
import {getToken, getTokenSign, requestTokenSync, createSign, setToken,refreshSync} from './token';
...
const http = {
  ...
  request: function (config) {
    ...
    if (conf.method == "post") {
      conf.headers['Api-Sign'] = createSign(config.data, timestamp, salt);
    }
