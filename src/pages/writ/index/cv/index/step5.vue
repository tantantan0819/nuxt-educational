                ...
                <div class="add_content">
                    ...
                    >
                        <el-form-item label="开始时间" prop="start_time">
                            <el-date-picker
                                type="date"
                                placeholder="请选择您的校园活动起始时间"
                                v-model="cvForm5.start_time"
                                format="yyyy-MM-dd"
                        ...
                        <el-form-item label="结束时间" prop="end_time">
                            <el-date-picker
                                type="date"
                                placeholder="请选择您的校园活动结束时间"
                                v-model="cvForm5.end_time"
                                format="yyyy-MM-dd"
                                value-format="yyyy-MM-dd"
                                class="widthAll"
                            ></el-date-picker>
    ...
    methods: {
        ...
        submitForm(formName) {
            ...
            _this.$refs[formName].validate(valid => {
                if (valid) {
                    http.post("/customer-school-exp/add", _this.cvForm5).then(
                        res => {
