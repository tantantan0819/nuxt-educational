    ...
    <div class="cv_step2">
      ...
      <div class="person_content">
        <div class="person_item">
          ...
          <span class="con" v-if="person.avatar"><img :src="person.avatar" alt=""/></span>
          <span class="con" v-else><img src="/images/avatar.jpg" alt=""/></span>
          <span class="modify">
            <i>
               <el-upload
                 class="upload-demo"
        ...
        <div class="person_item">
          ...
          <span class="con">******</span>
          <span class="modify" @click="visiblePssword=true"><i>修改密码</i></span>
        </div>
        <div class="person_item">
...
<!--          <span class="modify" @click="visibleEmail=true"><i>修改邮箱</i></span>-->
    ...
    <div class="add person_change">
      <el-dialog title="" :visible.sync="visiblePssword">
        ...
        <div class="add_content">
          <el-form :model="passwordForm" :rules="passwordRules" status-icon ref="passwordForm" label-width="0">
            <el-form-item prop="new_password">
              <el-input v-model="passwordForm.new_password" placeholder="请输入新密码" autocomplete="off"
                        type="password" show-password></el-input>
            </el-form-item>
            <el-form-item prop="confirm">
              <el-input v-model="passwordForm.confirm" placeholder="请确认新密码" autocomplete="off"
                        type="password" show-password></el-input>
            </el-form-item>
          </el-form>
          <div class="footer_button active">
            <span @click="visiblePssword=false"><i>取消</i></span>
    ...
    <div class="add person_change">
      <el-dialog title="" :visible.sync="visiblePhone">
        ...
        <div class="add_content">
          <el-form :model="phoneForm" status-icon :rules="phoneRules" ref="phoneForm" label-width="0px">
            ...
            <div class="code">
              <el-form-item prop="code">
                <el-input type="text" v-model.trim="phoneForm.code" placeholder="请输入短信验证码"
                          autocomplete="off"></el-input>
              </el-form-item>
          ...
          <div class="footer_button active">
            <span @click="visiblePhone=false"><i>取消</i></span>
    ...
    <div class="add person_change">
      <el-dialog title="" :visible.sync="visibleEmail">
        ...
        <div class="add_content">
          <el-form :model="emailForm" :rules="emailRules" status-icon ref="emailForm" label-width="0">
            <el-form-item prop="email">
              <el-input v-model="emailForm.email" placeholder="请输入新的邮箱" autocomplete="off"></el-input>
            </el-form-item>
            <div class="code">
              <el-form-item prop="code">
                <el-input type="text" v-model.trim="emailForm.code" placeholder="请输入邮箱验证码"
                          autocomplete="off"></el-input>
              </el-form-item>
          ...
          <div class="footer_button active">
            <span @click="visibleEmail=false"><i>取消</i></span>
        ...
        data() {
            ...
            return {
                ...
                emailRules: {
                    ...
                    code: [
                        {password: true, message: '请输入邮箱验证码', trigger: 'blur'}
                    ]
                }
            }
        },
        ...
        methods: {
            ...
            submitEmail(formName) {
                ...
                _this.$refs[formName].validate((valid) => {
                    if (valid) {
                        uhttp.post('/security/bind-email', _this.emailForm).then((res) => {
                            if (res) {
                                _this.$message({
                                    message: '邮箱修改成功！',
                                    type: 'success'
            ...
            submitPhone(formName) {
                ...
                _this.$refs[formName].validate((valid) => {
                    if (valid) {
                        uhttp.post('/security/bind-email', _this.phoneForm).then((res) => {
                            if (res) {
                                _this.$message({
                                    message: '手机修改成功！',
                                    type: 'success'
            ...
            submitPassword(formName, wrap) {
                ...
                _this.$refs[formName].validate((valid) => {
                    if (valid) {
                        uhttp.post('/password/set', _this.passwordForm).then((res) => {
                            if (res) {
                                _this.$message({
                                    message: '密码修改成功！',
                                    type: 'success'
